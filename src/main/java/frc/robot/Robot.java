...
import frc.robot.Subsystems.ChassisSubsytem;
...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    CommandScheduler.getInstance().setDefaultCommand(CHASSIS_SUBSYTEM, new ChassisDefaultCommand());
    ...
    CommandScheduler.getInstance().setDefaultCommand(PNEUMATICS, new PneumaticsDefaultCommand());
  }
